...
const EditWorkshop = () => {
  ...
  const loadWorkshop = async () => {
    ...
    try {
      ...
      // Check if user is the workshop creator
      if (data.company_id !== currentUser.id) {
        toast({
          title: "Access denied",
          description: "You can only edit your own workshops",
          variant: "destructive",
        });
        navigate(-1);
        return;
      ...
      // Populate form fields with workshop data
      setTitle(data.title || '');
      ...
      setDuration(data.duration ? data.duration.replace(' minutes', '') : '60');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your workshop has been updated successfully.",
      });
      
      navigate(`/company/workshops/${id}`);
    } catch (error: any) {
      console.error('Error updating workshop:', error);
      toast({
        title: "Failed to update workshop",
        description: error.message || "There was an error updating your workshop.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
  ...
  if (!currentUser || currentUser.role !== 'company') {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600">Only company accounts can edit workshops.</p>
        <Button 
          className="mt-4" 
          variant="outline" 
  ...
  return (
    <div className="max-w-4xl mx-auto mb-20">
      <div className="mb-6">
        ...
        <p className="text-gray-500">Update your workshop information</p>
      </div>
